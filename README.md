...
<head>
    ...
    <!-- 
      SÉCURITÉ HTML : Politique de sécurité du contenu (CSP). 
      Elle interdit l'exécution de scripts externes non autorisés pour bloquer les failles XSS.
    -->
...
<body>
    ...
    <main class="main-container" id="presentation">
        ...
        <div class="badge-grid">
            <span class="badge">Sécurisé (Meta CSP)</span>
